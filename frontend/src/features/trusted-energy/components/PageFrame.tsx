...
export function PageFrame({ title, back, action, children, className = "" }: { title: string; description?: string; eyebrow?: string; back?: string; action?: React.ReactNode; children: React.ReactNode; className?: string }) {
