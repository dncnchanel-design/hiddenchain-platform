...
export function IdentityPage() {
  ...
  return <PageFrame title="参与主体" description="企业是平台参与主体，个人账号归属于一家企业，并以企业名义使用获授权限。" action={<Button variant="secondary" onClick={() => Promise.all([remote.reload(), directoryRemote.reload()])} busy={remote.refreshing || directoryRemote.refreshing}><RefreshCw size={14} />刷新主体状态</Button>}>
