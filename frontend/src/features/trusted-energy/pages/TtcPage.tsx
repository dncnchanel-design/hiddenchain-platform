...
function statusLabel(value: string) {
  return ({ RUNNING: "执行中", PENDING: "待开始", SUCCEEDED: "已完成", ACTIVE: "进行中", COMPLETED: "已完成" } as Record<string, string>)[value] || labelForCode(value, "未知状态");
}
