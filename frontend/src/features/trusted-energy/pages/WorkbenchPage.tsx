...
function statusLabel(value: string) {
  return ({ ACTIVE: "已启用", READY: "已就绪", RUNNING: "执行中", PENDING_CONFIRMATION: "待确认", DRAFT: "待准备", SUBMITTED: "已提交", UNDER_REVIEW: "审核中", APPROVED: "已授权", REJECTED: "已拒绝", REVOKED: "已撤销", EXPIRED: "已过期" } as Record<string, string>)[value] || value || "未知";
}
...
function renderWorkbenchMetric(data: WorkbenchPayload) {
  ...
  return [
    ...
    { label: "计算任务", value: String(kpis.compute_jobs), detail: `${kpis.visible_tasks} 条 TTC 任务`, tone: "warning" as const },
