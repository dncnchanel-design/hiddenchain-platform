...
export function ContractPage() {
  ...
  if (!contractId) {
    ...
    return <PageFrame title="合同协商" description="从当前主体可见的真实合同列表进入协商详情。" action={<Button variant="secondary" onClick={listRemote.reload} busy={listRemote.refreshing}><RefreshCw size={14} />刷新</Button>}>
